...
.org 0x87D0100+0x200*(HookIndex-1)
  ...
  func_update_hyper_enemies:
    ; v1.0 - All enemies, bosses, and hazards at 200%.
    ...
    ; Always re-run updates
    ; Note: This may cause some triple updates if combined with Reprise (Hyper Enemies Room Modifier).
  ...
  func_hyper_quetz_wrapper:
    ...
    ; Ensure speeds are at 200% speeds
